...
const BoardAndTitleContainer = styled.div`
  display: flex;
    ...
    <HomePageContainer homePage>
      ...
      <HorizontalContainer centre>
        <BoardAndTitleContainer>
          <HorizontalContainer>
            <PersonSvg />
            <BoldText>Personal Boards</BoldText>
          </HorizontalContainer>

          <BoardsContainer>
            {userData.projects.map((project, index) => {
              return (
                <Link to={`/boards/${project.uid}`}>
                  <BoardBody background={project.background}>
                    <span>
                      <p>{project.name}</p>
                    </span>
                  </BoardBody>
